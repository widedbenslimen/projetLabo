  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      setStats({
        ...
        visibilites:userDocs.filter(d => d.visibilite).length,
      ...
      <aside className={`ch-sidebar ${sidebarOpen ? "open" : ""}`}>
        ...
        <div className="ch-sidebar-profile">
          ...
          <div className="ch-profile-info">
            <span className="ch-profile-name">{user.nom || "Cadre Technique"}</span>
        ...
        <div className="ch-content">
            ...
            <div className="ch-dashboard">
              ...
              <div className="ch-greeting">
                <div className="ch-greeting-text">
                  <h2>Bonjour, {user.nom || "Cadre Technique"} 👋</h2>
          ...
          {/* ═══════════ DOCUMENTS ═══════════ */}
                    ...
                    {activeTab === 'articles' && (
                      <div className="ch-tab-pane">
                        <ArticlePub
                          userRole={user.role || "CADRE_TECHNIQUE"}
                  ...
                  {activeTab === "labDocs" && (
                    <div className="ch-tab-pane">
                      <LabDocuments userRole={user.role || "CADRE_TECHNIQUE"} />
                    </div>
                  )}
